...
getGenomicAnnoStat <- function(peakAnno) {
    ...
    e1 <- getOption("epiSeeker.ignore_1st_exon")
    i1 <- getOption("epiSeeker.ignore_1st_intron")
    ids <- getOption("epiSeeker.ignore_downstream")
    ...
    ip <- getOption("epiSeeker.ignore_promoter_subcategory")
